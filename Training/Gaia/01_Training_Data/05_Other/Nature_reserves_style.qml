...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="214,229,225,255"/>
          <prop k="color_border" v="152,152,152,255"/>
          <prop k="offset" v="0,0"/>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="ATTRREL"/>
    <edittype labelontop="0" editable="1" type="0" name="AUTHORITY"/>
    <edittype labelontop="0" editable="1" type="0" name="CREATED"/>
    <edittype labelontop="0" editable="1" type="0" name="FEATREL"/>
    <edittype labelontop="0" editable="1" type="0" name="FEATTYPE"/>
    <edittype labelontop="0" editable="1" type="0" name="NAME"/>
    <edittype labelontop="0" editable="1" type="0" name="PID"/>
    <edittype labelontop="0" editable="1" type="0" name="PLANACC"/>
    <edittype labelontop="0" editable="1" type="0" name="RETIRED"/>
